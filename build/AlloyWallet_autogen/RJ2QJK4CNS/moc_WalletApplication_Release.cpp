/****************************************************************************
** Meta object code from reading C++ file 'WalletApplication.h'
**
...
#include "../../../src/Application/WalletApplication.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'WalletApplication.h' doesn't include <QObject>."
...
const QMetaObject WalletGui::WalletApplication::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_WalletGui__WalletApplication.data,
      qt_meta_data_WalletGui__WalletApplication,  qt_static_metacall, nullptr, nullptr}
};
...
void *WalletGui::WalletApplication::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ISettingsObserver"))
        return static_cast< ISettingsObserver*>(this);
