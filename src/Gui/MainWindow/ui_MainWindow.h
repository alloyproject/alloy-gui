...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/alloy"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutAlloyAction->setObjectName(QStringLiteral("m_aboutAlloyAction"));
        ...
        menuHelp->addAction(m_aboutAlloyAction);
...
#endif // QT_NO_TOOLTIP
        m_aboutAlloyAction->setText(QApplication::translate("MainWindow", "About Alloy", 0));
